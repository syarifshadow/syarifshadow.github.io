...
(function($, window, undefined){
  ...
  Hangman = {
    ...
    win: function(){
      ...
      this.msgTitle.html("Keren, Anda Menang!");
      // this is messy
      this.msgText.html("Anda telah menyelesaikan kata <span class='highlight'>" + rating.guesses + "</span> Tebaak!<br>Score: <span class='highlight'>" + rating.rating + "%</span>");
      this.showMsg();
    ...
    lose: function(){
      this.msgTitle.html("Anda Kalah.. kata tersebut adalah <span class='highlight'>"+ this.wrd.word +"</span>");
      this.msgText.html("tenang , masih ada satu lagi!");
      this.showMsg();
  ...
  var wordList = ["galuh", "gunungsari", "bapang", "inao", "sekartaji", "ragilkuning", "bussaba", "klana", "panji", "gajahmeto", "candrakirana", "eynao", "amiluhur", "designer", "developer", "module", "narawangsa", "cekel", "semirang", "prasanta", "amijaya", "mones", "emban", "Kaladinemprang", "amerdadu", "surodwipangga", "responsive", "Markomamang", "bilung"];
